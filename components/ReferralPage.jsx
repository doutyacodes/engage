    ...
    <ScrollView style={styles.container}>
      ...
      >
        ...
        <View>
          ...
          <Text style={{ color: "white", fontSize: hp(4), fontFamily: "raleway-bold" }}>
            Earn Rewards
          </Text>
        </View>
        <View
              ...
              return (
                ...
                >
                  <View style={{flexDirection:"row",gap:10,alignItems:"center"}}>
                    <Image source={require("../assets/images/wowcoin.png")} style={{width:wp(12),height:wp(12)}} />
                    <View style={{flex:1}}>
                      <Text style={{fontWeight:"bold",fontSize:hp(2)}}>Refer {item.referral_count}  people and get {item.reward_points} wowcoins</Text>
                    </View>
                    <Text  style={{fontWeight:"bold",fontSize:hp(1.9)}}>{item.user_referral_count}/{item.referral_count}</Text>
                  </View>
                </View>
              );
            })}
