...
import UserCommentStructure from "./UserCommentStructure";
import { useNavigation } from "@react-navigation/native";

const UserReplyStructure = ({
  item,
  isVisible,
  handleReply,
  handleReply2,
  ...
  return isVisible ? (
    <View style={{ flexDirection: "row", gap: 15 }}>
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <Text style={{ fontFamily: "raleway-bold", fontSize: 16 }}>{item.name}</Text>
...
export default UserReplyStructure;
