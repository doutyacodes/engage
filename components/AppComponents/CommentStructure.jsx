...
const CommentStructure = ({
  ...
  const [count, setCount] = useState(parseInt(item.comment_likes_count ? item.comment_likes_count : 0));
  ...
  return (
    <View style={{ position: "relative" }}>
      <TouchableOpacity>
        <Text style={{ fontSize: 14, color: "#525252",fontFamily:item.reported =="no" ? "nunito" : "nunito-italic" }}>{item.reported =="no" ? comment_text : "This comment is reported by you."}</Text>
      </TouchableOpacity>
      <View
        style={{
          flexDirection: "row",
