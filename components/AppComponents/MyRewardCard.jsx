  ...
  return (
    <View style={[styles.container, { padding: 5 }]}>
      {(item.expire == "yes" || item.cancelled == "yes") && (
        ...
        >
          <Text style={{ fontFamily: "raleway-bold",color:item.expire == "yes" ? "black" : "red",fontSize:hp(1.7) }}>{item.expire == "yes" ? "Expired" : "Cancelled"}</Text>
        </View>
      )}
      ...
      <TouchableOpacity
        ...
        style={{
          ...
          borderRadius: 13,
          overflow: "hidden",
          borderColor: (item.expire == "yes" || item.cancelled == "yes") ? "black" : "lightgrey",
          borderWidth: 1,
          shadowColor: "#000",
          shadowOffset: {
            width: 0,
