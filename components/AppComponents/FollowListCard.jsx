...
const FollowListCard = ({
          ...
          if (following == false) {
            if (item.account_status) {
              if (item.account_status == "private") {
                ...
                let toast = Toast.show(`You succesfully requested to follow ${item.name}`, {
  ...
  return (
    ...
    >
      <TouchableOpacity
        onPress={() => navigation.navigate(Navpass, { user_id: item.user_id })}
        style={{
          flexDirection: "row",
          gap: 10,
          alignItems: "center",
      ...
      >
        <Text style={{ color: "white", fontFamily: "raleway-bold",            textAlign: "center",
 }}>
