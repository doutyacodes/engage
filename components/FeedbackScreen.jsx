...
import Toast from "react-native-root-toast";
  ...
  const FeedbackScreen = ({ route }) => {
    ...
    const { page_id, user_id, type } = route.params;
    ...
    const submitData = async () => {
      ...
      try {
          ...
          const apiUrl = `${baseURL}/add-complaint.php`;
    ...
    return (
      <View style={{ flex: 1, padding: 15, paddingTop: 40 }}>
        ...
        >
          ...
          <Text style={{ fontSize: 17, color: "gray", fontFamily: "raleway-bold" }}>
            {type == "feedback" ? "Feedback" : "Complaint"}
          </Text>
          <TouchableOpacity onPress={submitData} disabled={isLoading}>
            {
              isLoading ? <ActivityIndicator size={"small"} color={"#3b99ff"} /> : <Text style={{ fontSize: 17, color: "gray", fontFamily: "raleway-bold" }}>
              Post
            </Text>
            }
          </TouchableOpacity>
          ...
          <BottomSheetScrollView style={styles.bottomSheetContent}>
            <View style={{ gap: 5 }}>
              ...
              >
                ...
                <Text style={{ fontSize: 16, fontFamily: "raleway-semibold" }}>
                  Add Photo
                </Text>
              </TouchableOpacity>
              <Divider />
